...
Repositorio do projeto no GitHub: \href{https://github.com/DebLuiza/TP01_ACIII/tree/main}{https://github.com/DebLuiza/TP01_ACIII/tree/main}.
...
A validacao automatizada atual e composta por 35 testes distribuidos nas secoes 7.1 a 7.5 do enunciado. O resultado consolidado foi:

\begin{verbatim}
RESULTADO FINAL: 35 PASS / 0 FAIL de 35 testes
>>> TODOS OS TESTES PASSARAM <<<
\end{verbatim}

A Tabela~\ref{tab:testes-cache} resume a cobertura por categoria.

\begin{table}[h]
\centering
\begin{tabular}{|c|c|c|}
\hline
\textbf{Categoria} & \textbf{Faixa de testes} & \textbf{Resultado} \\
\hline
READ (7.1) & T1--T5 & 5/5 PASS \\
\hline
WRITE (7.2) & T6--T10 & 5/5 PASS \\
\hline
REPLACE (7.3) & T11--T20 & 10/10 PASS \\
\hline
CONSIST (7.4) & T21--T30 & 10/10 PASS \\
\hline
EDGE (7.5) & T31--T35 & 5/5 PASS \\
\hline
\textbf{Total} & \textbf{T1--T35} & \textbf{35/35 PASS} \\
\hline
\end{tabular}
\caption{Resumo da cobertura funcional do testbench atualizado.}
...
\begin{itemize}
    ...
    \item acesso ao endereco extremo alto \texttt{8'hFC}.
\end{itemize}

Trecho representativo do log de simulacao:
\begin{verbatim}
--- [EDGE] T34: Read miss after reset (cache invalidated) ---
READ  | Addr: 8'h10 | Data: 32'h1004 | Hit: 0
--- [EDGE] T31: Read addr 0x00 (min) ---
READ  | Addr: 8'h0  | Data: 32'h1000 | Hit: 0
--- [EDGE] T32: Read addr 0xFC (max) ---
READ  | Addr: 8'hFC | Data: 32'h103f | Hit: 0
\end{verbatim}
